...
import { addVehicle } from "@/services/database";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Vehicle ${formData.number.toUpperCase()} has been added to your fleet`,
        variant: "default"
      });
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-green-100">Register a new vehicle to your fleet</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">  
                ...
                <p className="text-xs text-gray-500">
                  Enter the complete vehicle registration number as it appears on documents
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  Set the current operational status of the vehicle
                </p>
              </div>
